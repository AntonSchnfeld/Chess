...
public class MapChessBoardTest {
    private MapChessBoard<StandardPieceType> tested;
    ...
    public void givenManyPieces_whenGetPiecesOfType_thenPiecesOfTypeAndColour() {
        // Given
        StandardPieceType searchPieceType = StandardPieceType.PAWN;
        StandardPieceType otherPieceType = StandardPieceType.KNIGHT;
